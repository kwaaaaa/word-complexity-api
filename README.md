...
Processing errors are captured and stored on the request record.

The request status is updated to `failed`, the error message is persisted, and the Sidekiq job is retried automatically.
